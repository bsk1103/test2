...
large_buttons = {
    "나의 아바타": "아바타비디오.mp4",  # 이 경로를 실제 아바타 비디오 파일
    "나를 표현한 음악": "잔잔노래.mp3"  
}
...
small_buttons = {
    ...
    "좋아하는 것": "게임하기와 친구들과 노는 것.",
    "싫어하는 것": "적정 선을 유지하면 딱히 없음.",
    "자기 소개": "이름은 봉성권, 나이는 19살이야.",
    "진로 준비": "동아리 활동을 열심히 하고 있고, 관련 뉴스나 소식을 통해 궁금한 점을 찾아보고 해결함.",
    "취미 활동": "내 취미는 게임하기.",
    "성공 사례": "친구들과 멘토링을 하여 수학 성적을 올려본 경험이 있어."
}
